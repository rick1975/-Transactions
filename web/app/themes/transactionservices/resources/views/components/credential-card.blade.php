    ...
    <div class="p-6">
        ...
        @if($credential['logo1'])
            <div class="h-14 flex items-center mb-2">
                <img src="{{ home_url('/app/uploads/' . $credential['logo1']) }}" alt="{{ $credential['partij1'] }}" class="max-w-[90px] w-auto object-contain">            </div>
        @else
            <div class="h-14 flex items-center mb-2">
        ...
        <div class="border-t border-slate-200 pt-4 mt-2">
            @if($credential['logo2'])
                <div class="h-14 flex items-center mb-2"><img src="{{ home_url('/app/uploads/' . $credential['logo2']) }}" alt="{{ $credential['partij2'] }}" class="max-w-[90px] w-auto object-contain"></div>
